...
namespace CashCanvas.Migrations
{
    ...
    [Migration("20251122013105_AddUserStatsUserIdForeignKey")]
    partial class AddUserStatsUserIdForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CashCanvas.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CashCanvas.Entities.UserStats", b =>
                {
                    b.Property<int>("UserStatsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("TotalCounterClicks")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("CashCanvas.Entities.UserStats", b =>
                {
                    b.HasOne("CashCanvas.Data.ApplicationUser", null)
                        .WithMany()
